...
//        Stage1.fallenSpeed = EditorGUILayout.FloatField("上昇速度", Stage1.fallenSpeed);
//        Stage1.raiseSpeed = EditorGUILayout.FloatField("落ちる速度", Stage1.raiseSpeed);
...
//        Stage1.fallenSpeed2 = EditorGUILayout.FloatField("上昇速度", Stage1.fallenSpeed2);
//        Stage1.raiseSpeed2 = EditorGUILayout.FloatField("落ちる速度", Stage1.raiseSpeed2);
